/// functions implementing a statically-allocated minheap
///
/// This file defines a customized min-heap which operates on [nodes](@ref node)
...
/// a static min-heap for up to 256 nodes
///
...
public:	
	...
	/// function! (use [cleanTree](@ref cleanTree)
	node* pop_smallest();
